...
export const metadata: Metadata = {
  title: "Grand Vista Hotel - Luxury Accommodation & 5-Star Service",
  description: "Experience unparalleled luxury at Grand Vista Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium rooms, hotel suites, spa wellness, fine dining, business hotel, city hotel",
  metadataBase: new URL("https://grandvista.com"),
  alternates: {
    canonical: "https://grandvista.com"
  },
  openGraph: {
    title: "Grand Vista Hotel - Luxury Accommodation & 5-Star Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel with premium rooms, world-class amenities, and exceptional hospitality.",
    url: "https://grandvista.com",
    siteName: "Grand Vista Hotel",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1763411498419-mrvinr4m.jpg",
  ...
  twitter: {
    ...
    title: "Grand Vista Hotel - Luxury Accommodation & 5-Star Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel with premium rooms, world-class amenities, and exceptional hospitality.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SAuZG11YN2jMHmu0FsR9Di3IL/uploaded-1763411498419-mrvinr4m.jpg"]
  },
  robots: {
    index: true,
    follow: true
